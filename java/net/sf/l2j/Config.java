...
public static final int AURAFANG = 81111;
public static final int RAYBLADE = 81112;
public static final int WAVEBRAND = 81113;
		...
		try
		{
			...
			try
			{
				...
				if (sstl.length != 0)
				{
					...
					for (String st : sstl)
					{
						if (st.equalsIgnoreCase("day") || st.equalsIgnoreCase("hour")
								|| st.equalsIgnoreCase("minute"))
						{
			...
			try
			{
				...
				SUMMON_PATK_MODIFIER = Integer.parseInt(Character.getProperty("SummonPAtkModifier", "1"));
				SUMMON_MATK_MODIFIER = Integer.parseInt(Character.getProperty("SummonMAtkModifier", "1"));
			}
			catch (Exception e)
			{
				e.printStackTrace();
			...
			try
			{
				...
				ALLOW_NETWORK_VOTE_REWARD = Boolean.parseBoolean(Events.getProperty("AllowNetworkVoteReward", "false"));
		        NETWORK_SERVER_LINK = Events.getProperty("NetworkServerLink", "");
		        NETWORK_VOTES_DIFFERENCE = Integer.parseInt(Events.getProperty("NetworkVotesDifference", "5"));
		               NETWORK_REWARD_CHECK_TIME = Integer.parseInt(Events.getProperty("NetworkRewardCheckTime", "5"));
		        ...
		        NETWORK_DUALBOXES_ALLOWED = Integer.parseInt(Events.getProperty("NetworkDualboxesAllowed", "1"));
		        ALLOW_NETWORK_GAME_SERVER_REPORT = Boolean.parseBoolean(Events.getProperty("AllowNetworkGameServerReport", "false"));
		        ALLOW_TOPZONE_VOTE_REWARD = Boolean.parseBoolean(Events.getProperty("AllowTopzoneVoteReward", "false"));
		        TOPZONE_SERVER_LINK = Events.getProperty("TopzoneServerLink", "");
		        TOPZONE_VOTES_DIFFERENCE = Integer.parseInt(Events.getProperty("TopzoneVotesDifference", "5"));
		        TOPZONE_REWARD_CHECK_TIME = Integer.parseInt(Events.getProperty("TopzoneRewardCheckTime", "5"));
		        ...
		        TOPZONE_DUALBOXES_ALLOWED = Integer.parseInt(Events.getProperty("TopzoneDualboxesAllowed", "1"));
		        ALLOW_TOPZONE_GAME_SERVER_REPORT = Boolean.parseBoolean(Events.getProperty("AllowTopzoneGameServerReport", "false"));
		        ALLOW_HOPZONE_VOTE_REWARD = Boolean.parseBoolean(Events.getProperty("AllowHopzoneVoteReward", "false"));
		        HOPZONE_SERVER_LINK = Events.getProperty("HopzoneServerLink", "");
		        HOPZONE_VOTES_DIFFERENCE = Integer.parseInt(Events.getProperty("HopzoneVotesDifference", "5"));
		        HOPZONE_REWARD_CHECK_TIME = Integer.parseInt(Events.getProperty("HopzoneRewardCheckTime", "5"));
		        ...
		        HOPZONE_DUALBOXES_ALLOWED = Integer.parseInt(Events.getProperty("HopzoneDualboxesAllowed", "1"));
		        ALLOW_HOPZONE_GAME_SERVER_REPORT = Boolean.parseBoolean(Events.getProperty("AllowHopzoneGameServerReport", "false"));
			}
			catch (Exception e)
			{
				e.printStackTrace();
...
public static boolean setParameterValue(String pName, String pValue)
{
	...
	else if (pName.equalsIgnoreCase("SummonPAtkModifier"))
		SUMMON_PATK_MODIFIER = Integer.parseInt(pValue);
	else if (pName.equalsIgnoreCase("SummonMAtkModifier"))
		SUMMON_MATK_MODIFIER = Integer.parseInt(pValue);
