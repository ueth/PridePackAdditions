...
public L2CharTemplate(StatsSet set)
{
	...
	baseMDef = set.getInteger("baseMDef", 34);
	basePAtkSpd = set.getInteger("basePAtkSpd");
	baseMAtkSpd = set.getInteger("baseMAtkSpd");
	baseMReuseRate = set.getFloat("baseMReuseDelay", 2.3f);
	...
	baseMCritRate = set.getInteger("baseMCritRate", 60); // CT2: The magic critical rate has been increased to 10 times.
