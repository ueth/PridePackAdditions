...
{
	return type.equalsIgnoreCase("L2RaidBoss") && level <= 90;
}
public boolean isLevelTwoRB()
{
	return type.equalsIgnoreCase("L2RaidBoss") && level > 90 && level <= 92;
}

public boolean isLevelThreeRB()
{
	return type.equalsIgnoreCase("L2RaidBoss") && level > 92 && level < 94;
}

public boolean isLevelFourRB()
{
	return type.equalsIgnoreCase("L2RaidBoss") && level >= 94;
}
...
public String getDifficulty()
{
	if (isLevelOneRB())
		return "Easy";
	else if (isLevelTwoRB())
		return "Medium";
	else if (isLevelThreeRB())
		return "Hard";
	else if (isLevelFourRB())
		return "Veteran";
	else
	    return "Uknown";
}
