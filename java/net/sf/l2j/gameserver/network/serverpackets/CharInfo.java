...
protected final void writeImpl()
{
	...
	else
	{
		...
		int hair1item, hair2item, hair1aug, hair2aug;
		...
		{
			writeC(_activeChar.isDisguised() ? 1 : 0);	// invisible = 1  visible =0
		}*/
		...
		writeD(_activeChar.getClassId().getId());
		writeD(0x00); //?
		writeC(olympiad || _activeChar.isMounted() ? 0 : /*_activeChar.isDisguised() ? Math.max(_activeChar.getEnchantEffect() + Rnd.get(-5, 1), 0) :*/ _activeChar.getEnchantEffect());
