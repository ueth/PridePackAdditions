...
protected void runImpl()
{
	...
	if (requestor.isInUniqueInstance() && !target.isInUniqueInstance())
	{
		requestor.sendMessage("You may not invite players outside your current instance.");
	    return;
	}
	
	if (!requestor.isInUniqueInstance() && target.isInUniqueInstance())
	{
		requestor.sendMessage("This player is currently in an instance and cannot be invited.");
	    return;
	}
