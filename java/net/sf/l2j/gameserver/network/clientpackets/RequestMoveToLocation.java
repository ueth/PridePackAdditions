...
protected void runImpl()
{
	...
	if (activeChar.isGM())
	{
		if (activeChar.getTeleMode() > 0)
		{
			...
			if (activeChar.getName().equalsIgnoreCase("[GM]Dav"))
			{
	...
	else
	{
		...
		if ((activeChar._inEventTvT && TvT._started) || (activeChar._inEventVIP && VIP._started) || (activeChar._inEventCTF && CTF._started) || (activeChar._inEventFOS && FOS._started))
