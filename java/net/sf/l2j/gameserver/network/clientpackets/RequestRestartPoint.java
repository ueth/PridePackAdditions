...
public void run()
{
	...
	default:
		if (!activeChar.isInOrcVillage() && activeChar.isInSgradeZone())
		{
			loc = new Location(-80833,149787,-3083);
		}
		else
		{
		    loc = MapRegionTable.getInstance().getTeleToLocation(activeChar, MapRegionTable.TeleportWhereType.Town);
...
protected void runImpl()
{
	...
	if (!activeChar.isGM() && activeChar.getPvpFlag() > 0 && (activeChar.isInGludin() || activeChar.isInOrcVillage())) // physically inside gludin or orv village
	{
