...
public static boolean divorce(L2PcInstance activeChar)
{
...
public static boolean engage(L2PcInstance activeChar)
{
	// check target
...
public static boolean goToLove(L2PcInstance activeChar)
{
	if (!activeChar.isThisCharacterMarried())
	{
...
public static boolean canGoToLove(L2PcInstance activeChar, L2PcInstance partner)
{
	...
	if (!activeChar.isGM())
	{
		...
		if (activeChar.isInJail() || activeChar.isFlyingMounted() || Olympiad.getInstance().isRegistered(activeChar) || activeChar.isInOlympiadMode() ||
				activeChar.inObserverMode() || activeChar.isAlikeDead() || activeChar.isInsideZone(L2Character.ZONE_SIEGE))
		{
