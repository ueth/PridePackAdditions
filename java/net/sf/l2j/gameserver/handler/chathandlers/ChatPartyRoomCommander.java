...
{
	if (activeChar._inEventFOS && FOS._started)
	{
		if (activeChar.isAFOSLeader())
		{
			if (!activeChar.getFloodProtectors().getPartyRoomCommander().tryPerformAction("party room commander"))
			{
				activeChar.sendMessage("Wait 20 seconds");
				return;
			}
