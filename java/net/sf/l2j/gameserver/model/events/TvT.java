...
public static final int MEDAL_OF_VICTORY = 4676;
		...
		synchronized (topkiller)
		{
			for (L2PcInstance player : _players)
			{
				if (player != null)
				{
					...
					if (player._countTvTkills > 0 && (player._countTvTkills > _top1Kills || (player._countTvTkills >= _top1Kills && player._countTvTdies < topkiller[0]._countTvTdies)))
					{
						topkiller[0] = player;
			...
			for (L2PcInstance player : _players)
			{
				if (player != null && player._countTvTkills > 0 && player != topkiller[0] && !player._teamNameTvT.equals(topkiller[0]._teamNameTvT) && (player._countTvTkills > _top2Kills || (player._countTvTkills >= _top2Kills && player._countTvTdies < topkiller[1]._countTvTdies)))
				{
					topkiller[1] = player;
			...
			for (L2PcInstance player : _players)
			{
				if (player != null && player._countTvTkills > 0 && player != topkiller[0] && player != topkiller[1] && !player._teamNameTvT.equals(topkiller[0]._teamNameTvT) && !player._teamNameTvT.equals(topkiller[1]._teamNameTvT) && (player._countTvTkills > _top3Kills || (player._countTvTkills >= _top3Kills && player._countTvTdies < topkiller[2]._countTvTdies)))
				{
					topkiller[2] = player;
...
public static void rewardTeam(String teamName, L2PcInstance[] topkillers)
{
	...
	for (L2PcInstance player : _players)
	{
		try
		{
			...
			{
				if (player._countTvTkills > 0 || /*player._countTvTdies > 4 ||*/ Config.TVT_PRICE_NO_KILLS)
				{
					if (player._teamNameTvT.equals(teamName))
					{
						...
						player.addItem("TVT Event: " + _eventName, TvT.MEDAL_OF_VICTORY, 1, player, true);
					}
					else
					{
						...
						if (moreThanTwoTeams)
							rewardAmount = (2*_rewardAmount)/3;
						else
							rewardAmount = _rewardAmount/3;
						...
						if (moreThanTwoTeams)
							...
							replyMSG.append("<html><body>Your team did not win the event, but you are rewarded 1/3 of the event prize for trying.</body></html>");
			...
			if (player._inEventTvT && _started)
			{
				if (player.isDead())
				{
					...
					player.teleToLocation(_teamsX.get(_teams.indexOf(player._teamNameTvT)), _teamsY.get(_teams.indexOf(player._teamNameTvT)), _teamsZ
							.get(_teams.indexOf(player._teamNameTvT)), false);
					player.doRevive();
