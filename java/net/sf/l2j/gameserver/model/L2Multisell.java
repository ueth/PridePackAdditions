...
public MultiSellIngredient(int itemId, long itemCount, int enchantLevel, boolean isTaxIngredient, boolean mantainIngredient)
{
	this(itemId, itemCount, enchantLevel, 0, -2, 0, 0, 0, 0, 0, 0, 0, isTaxIngredient, mantainIngredient);
}
...
protected MultiSellEntry parseEntry(Node n)
{
	...
	for (n = first; n != null; n = n.getNextSibling())
	{
		if ("ingredient".equalsIgnoreCase(n.getNodeName()))
		{
			...
			if (enchantlevel > 0)
				e = new MultiSellIngredient(id, count, enchantlevel, isTaxIngredient, mantainIngredient);
			else
		...
		else if ("production".equalsIgnoreCase(n.getNodeName()))
		{
			...
			if (enchantlevel > 0)
				e = new MultiSellIngredient(id, count, enchantlevel, false, false);
			else
				e = new MultiSellIngredient(id, count, false, false);
