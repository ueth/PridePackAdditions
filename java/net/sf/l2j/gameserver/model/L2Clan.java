...
// Sub-unit types
    ...
    public String getClanSkillsIcon(int skillId) {
        switch (skillId) {
            case 370: //Clan Vitality
                return "icon.skill0370";
            case 371: //Clan Spirituality
                return "icon.skill0371";
            case 372: //Clan Essence
                return "icon.skill0372";
            case 373: //Clan Lifeblood
                return "icon.skill0373";
            case 374: //Clan Morale
                return "icon.skill0374";
            case 375: //Clan Lifeblood
                return "icon.skill0375";
            case 376: //Clan Lifeblood
                return "icon.skill0376";
            case 377: //Clan Lifeblood
                return "icon.skill0377";
            case 378: //Clan Lifeblood
                return "icon.skill0378";
            case 379: //Clan Lifeblood
                return "icon.skill0379";
            case 380: //Clan Lifeblood
                return "icon.skill0380";
            case 381: //Clan Vitality
                return "icon.skill0381";
            case 382: //Clan Spirituality
                return "icon.skill0382";
            case 383: //Clan Essence
                return "icon.skill0383";
            case 384: //Clan Lifeblood
                return "icon.skill0384";
            case 385: //Clan Morale
                return "icon.skill0385";
            case 386: //Clan Lifeblood
                return "icon.skill0386";
            case 387: //Clan Lifeblood
                return "icon.skill0387";
            case 388: //Clan Lifeblood
                return "icon.skill0388";
            case 389: //Clan Lifeblood
                return "icon.skill0389";
            case 390: //Clan Lifeblood
                return "icon.skill0390";
            case 391: //Clan Lifeblood
                return "icon.skill0391";
            default:
    ...
    public Fort getFort() {
        return FortManager.getInstance().getFortByOwner(this);
    }
    ...
    public void updateClanInDB() {
        ...
        try {
            con = L2DatabaseFactory.getInstance().getConnection();
            statement = con.prepareStatement("UPDATE clan_data SET leader_id=?,ally_id=?,ally_name=?,reputation_score=?,ally_penalty_expiry_time=?,ally_penalty_type=?,char_penalty_expiry_time=?,dissolving_expiry_time=?,ally_crest_id=? WHERE clan_id=?");
    ...
    public SubPledge createSubPledge(L2PcInstance player, int pledgeType, int leaderId, String subPledgeName) {
        ...
        if (pledgeType != -1 &&
                ((getReputationScore() < Config.KNIGHT_UNIT_COST && pledgeType < L2Clan.SUBUNIT_KNIGHT1) ||
                        (getReputationScore() < Config.ROYAL_GUARD_COST && pledgeType > L2Clan.SUBUNIT_ROYAL2))) {
            if (pledgeType < L2Clan.SUBUNIT_KNIGHT1) {
                player.sendMessage("You need " + Config.KNIGHT_UNIT_COST + " clan reputation points");
            } else {
                player.sendMessage("You need " + Config.ROYAL_GUARD_COST + " clan reputation points");
            }
    ...
    private BattlePassClan _battlePass;
