...
_isEventVIPNPC = false, _isEventVIPNPCEnd = false;
...
public void loadDropHTML()
{
	final StringBuilder html1 = StringUtil.startAppend(1000,
			"<html><body><title>Info of " + getName() + "</title>" +
					"<center><font color=\"LEVEL\">[Combat Stats]</font></center>" +
					"<table border=0 width=\"102%\">" +
					"<tr><td width=30>MaxHP</td><td width=50>",
					formatString((getMaxHp())),
					"</td><td width=30>MaxMP</td><td width=50>",
					formatString(getMaxMp()),
					"</td></tr>" +
							"<tr><td width=30>P.Atk.</td><td width=50>",
							formatString(getPAtk(null)),
							"</td><td width=30>M.Atk.</td><td width=50>",
							formatString(getMAtk(null, null)),
							"</td></tr>" +
									"<tr><td width=30>P.Def.</td><td width=50>",
									formatString(getPDef(null)),
									"</td><td width=30>M.Def.</td><td width=50>",
									formatString(getMDef(null, null)),
									"</td></tr>" +
											"<tr><td width=30>Accu</td><td width=50>",
											formatString(getAccuracy(null)),
											"</td><td width=30>Eva</td><td width=50>",
											formatString(getEvasionRate(null)),
											"</td></tr>" +
													"<tr><td width=30>Crit</td><td width=50>",
													formatString(getCriticalHit(null, null)),
													"</td><td width=30>Speed</td><td width=50>",
													formatString(getRunSpeed()),
													"</td></tr>" +
															"<tr><td width=30>AtkSpd</td><td width=50>",
															formatString(getPAtkSpd(null)),
															"</td><td width=30>CstSpd</td><td width=50>",
															formatString(getMAtkSpd(null)),
															"</td></tr>" +
																	"<tr><td width=30>Race</td><td width=50>",
																	getTemplate().getRace().toString(),
																	"</td><td width=30>Exp.</td><td width=50>",
																	formatString(getExpReward()),
																	"</td></tr>" +
																			"<tr><td width=30>AtkEle</td><td width=50>",
																			getAttackElementString(),
																			"</td><td width=30>DefEle</td><td width=50>",
																			getDefenseElementString(),
																			"</td></tr>" +
																					"</table>"
			);
	...
	StringUtil.append(html1,
			"<br><center><font color=\"LEVEL\">[Special Info]</font></center>" +
					"<table border=0 width=\"100%\">" +
					"<tr><td width=30px>Elite:</td><td>",
					String.valueOf((getElite() > 0)),
					"</td><td width=30px>Rare:</td><td>",
					String.valueOf((getRare() > 0)),
					"</td></tr>" +
							"<tr><td width=30px>Random X:</td><td>",
							String.valueOf(spawn != null ? spawn.getSpawnType() == 1 ? "at a random pc" : spawn.getRandomX() : "N/A"),
							"</td><td width=30px>Random Y:</td><td>",
							String.valueOf(spawn != null ? spawn.getSpawnType() == 1 ? "at a random pc" : spawn.getRandomY() : "N/A"),
							"</td></tr>" +
									"<tr><td width=30px>Spawn Time:</td><td>",
									String.valueOf(time == 2 ? "Night" : time == 1 ? "Day" : "Always"),
									"</td>" +
											"<td width=30px>Respawn:</td><td>",
											respawntime,
											"</td></tr>" +
													"<tr><td width=30>Faction</td><td width=50>",
													getFactionIdString(),
													"</td><td width=30>AggroRange</td><td width=50>",
													formatString(getAggroRange()),
													"</td></tr>" +
															"<tr><td width=30>FactionRange</td><td width=50>",
															formatString(getFactionRange()),
															"</td></tr>" +
																	"</table>"
			);
	
	StringUtil.append(html1,
			"<br><center><font color=\"LEVEL\">[Special Modifiers]</font></center>" +
					"<table border=0 width=\"100%\">"
			);
	
	if (getSpawn().getMinPopRequiredToSpawn() >= 10)
		StringUtil.append(html1, "<tr><td><font color=977932>Spawns only if > "+getSpawn().getMinPopRequiredToSpawn()+" players online</font></td></tr>");
	...
	for (L2Skill skill : getAllSkills())
	{
		if (skill != null)
		{
			...
			{
				StringUtil.append(html1, "<tr><td><font color=911966>"+desc);
				StringUtil.append(html1, "</font></td></tr>");
			}
		}
	}
	
	StringUtil.append(html1, "</table>");
	
	if (getTemplate().getDropData() != null)
	{
		StringUtil.append(html1,
				"<br><center><font color=\"LEVEL\">[Drop Info]</font></center>" +
						"<br1>Rates: <font color=\"55ff55\">100%</font> <font color=\"33ffff\">50%+</font> <font color=\"3366ff\">15%+</font>" +
						" <font color=\"3239ff\">3%+</font> <font color=\"ff5194\">1%+</font> <font color=\"ff3310\">1%-</font> <font color=\"777777\">0,1%-</font>" +
						"<table border=0 width=\"100%\">"
				);
		...
		for (L2DropCategory cat : getTemplate().getDropData())
		{
			for (L2DropData drop : cat.getAllDrops())
			{
				...
				if (!list)
				{
					...
					itemIcon = item.getItemImage();
				}
				else
				{	
					itemName = ItemLists.getInstance().getListName(drop.getItemId());
				    itemIcon = ItemLists.getInstance().getListImage(drop.getItemId());
				} 
				...
				String dropchance = (drop.getChance() < 10000 && drop.getChance() >= 1000) ? "1-" : drop.getChance() < 1000 ? "-0,1" : String.valueOf(drop.getChance()/10000);
				
				StringUtil.append(html1,
						"<tr><td><img src=\"",itemIcon,"\" height=32 width=32></td><td width=159><table cellspacing=4 cellpadding=0><tr><td height=20><font color=\"",
						color,
						"\">",
						itemName,
						"</font></td></tr><tr><td height=20>",
						dropcount,
						"</td></tr></table></td><td><font color=\"",color,"\">",
						dropchance,
						"%</font></td></tr>"
						);
			}						
	...
	_dropHTML.setHtml(html1.toString());
}
...
{
	return (!isAPC()) &&
			(Config.MAX_NPC_ANIMATION > 0 && !getTemplate().AI.equals(AIType.CORPSE) && getNpcId() != 95627);
}
		...
		else if (!isAutoAttackable(player))
		{
			...
			else
			{
				...
				if (isEventMob)
					...
					FOS.showArtifactHtml(player, String.valueOf(getObjectId()));
...
public void onActionShift(L2GameClient client)
{
	...
	if (player.isGM())
	{
		...
		StringUtil.append(html1,
				"<center><table><tr><td><button value=\"Edit NPC\" action=\"bypass -h admin_edit_npc ",	String.valueOf(getTemplate().npcId),"\" width=80 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" +
						"<td><button value=\"Show DropList\" action=\"bypass -h admin_show_droplist ", String.valueOf(getTemplate().npcId),"\" width=100 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>" +								
								"<td><button value=\"Skill list\" action=\"bypass -h admin_show_skilllist_npc ", String.valueOf(getTemplate().npcId),"\" width=80 height=20 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>" +
				"</table></center><br>");
														...
														"</td></tr>" +
																...
																"</td></tr>" +
																		...
																		"</td></tr>" +
																				...
																				String.valueOf(getAccuracy(null)),
																				"</td><td>Evasion</td><td>",
																				...
																				"</td></tr>" +
																						...
																						"</td></tr>" +
																								...
																								String.valueOf(getPAtkSpd(null)),
																								"</td><td>Cast.Speed</td><td>",
																								String.valueOf(getMAtkSpd(null)),
																								"</td></tr>" +
																										"</table><br>" +
...
public boolean doDie(L2Character killer)
{
	...
	if(getGlobalEvent() != null)
		getGlobalEvent().monsterDies(this);
...
{
	if (Config.CHECK_KNOWN) activeChar.sendMessage("Added NPC: "+getName());
	if (getRunSpeed() == 0)
