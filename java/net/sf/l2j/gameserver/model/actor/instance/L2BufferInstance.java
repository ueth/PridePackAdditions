 ...
 * <br>
 * 
 * - Methods that overrides to superclass' (L2FolkInstance): <li>onAction <li>
 * onBypassFeedback <li>onActionShift <br>
 * <br>
 * 
 * - Methods to show html windows: <li>showGiveBuffsWindow <li>
 * showManageSchemeWindow <li>showEditSchemeWindow <br>
 * </br>
 * 
 * - Methods to get and build info (Strings, future html content) from character schemes, state,
 * etc. <li>getPlayerSchemeListFrame: Returns a table with player's schemes names <li>
 * getGroupSkillListFrame: Returns a table with skills available in the skill_group <li>
...
private final static int[] FIGHTER_SHIELD_ZERK = {1035, 1268, 1068, 1040, 1204, 1077, 1086, 1242, 1240, 1243, 1304, 1045, 1036, 1388, 1062, 1363, 4700, 271, 272, 274, 275, 264, 267, 268, 269, 304, 364, 349};
private final static int[] FIGHTER_EVASION_ZERK = {1035, 1268, 1068, 1040, 1204, 1077, 1086, 1242, 1240, 1087, 1045, 1036, 1388, 1062, 1363, 4699, 271, 272, 274, 275, 266, 264, 267, 268, 269, 304, 364, 349};
private final static int[] FIGHTER_NONE_ZERK = {1035, 1268, 1068, 1040, 1204, 1077, 1086, 1242, 1240, 1045, 1036, 1388, 1062, 1363, 4700, 271, 272, 274, 275, 530, 264, 267, 268, 269, 304, 364, 529, 349};

private final static int[] FIGHTER_SHIELD_NOZERK = {1035, 1268, 1068, 1040, 1204, 1077, 1086, 1242, 1240, 1243, 1304, 1045, 1036, 1389, 1363, 4700, 271, 272, 274, 275, 264, 267, 268, 269, 304, 364, 349};
private final static int[] FIGHTER_EVASION_NOZERK = {1035, 1268, 1068, 1040, 1204, 1077, 1086, 1242, 1240, 1087, 1045, 1036, 1389, 1363, 4699, 271, 272, 274, 275, 266, 264, 267, 268, 269, 304, 364, 349};
private final static int[] FIGHTER_NONE_NOZERK = {1035, 1268, 1068, 1040, 1204, 1077, 1086, 1242, 1240, 1045, 1036, 1388, 1363, 4700, 271, 272, 274, 275, 530, 264, 267, 268, 269, 304, 364, 529, 349};

private final static int[] MAGE_ZERK = {1304, 1243, 1389, 1040, 1045, 1085, 1059, 1303, 1204, 1363, 1062, 1036, 1035, 1259, 4703, 273, 276, 365, 530, 264, 267, 268, 304, 349, 529};

private final static int[] MAGE_NOZERK = {1304, 1243, 1389, 1040, 1045, 1085, 1059, 1303, 1204, 1363, 1036, 1035, 1259, 4703, 273, 276, 365, 530, 264, 267, 268, 304, 349, 529};
	...
	else if (currentCommand.startsWith("gBuff"))
	{
		...
		if (token != null)
		{
			...
			if (buff >= 0 && buff <= 7)
			{
				...
				NpcHtmlMessage html = new NpcHtmlMessage(getObjectId());
				html.setFile(PARENT_DIR + "35461.htm");
				sendHtmlMessage(player, html);
			}
		}
	}
				...
				if (name != null)
				{
					if (name.length() > 14)
					{
						...
						showManageSchemeWindow(player);
							...
							&& CharSchemesTable.getInstance().getAllSchemes(player.getObjectId()).size() == 6)
					{
...
private void showGiveBuffsWindow(L2PcInstance player, String targettype)
{
	...
	else
	{
		...
		for (FastMap.Entry<String, FastList<Integer>> e = map.head(), end = map.tail(); (e = e.getNext()) != end;)
		{
			...
			tb.append("<tr><td width=\"90\"><a action=\"bypass -h npc_%objectId%_givebuffs "
					+ targettype + " " + e.getKey() + " " + String.valueOf(cost) + "\">"
					+ e.getKey() + "</a></td><td>Fee: " + String.valueOf(cost) + "</td></tr>");
		}
		tb.append("</table>");
	}
	tb.append("</body></html>");
...
private void showManageSchemeWindow(L2PcInstance player)
{
	...
	{
		tb.append("Here is a list of your schemes. To delete a scheme, click on the drop button. To create, enter your scheme name into the name box and press create. "
				+ "Each scheme must have different name. Name must have up to 14 chars. Spaces (\" \") are not allowed. DO NOT click on Create until you have filled in the name<br>");
		tb.append("<table>");
		...
		for (FastMap.Entry<String, FastList<Integer>> e = CharSchemesTable.getInstance().getAllSchemes(player.getObjectId()).head(), end = CharSchemesTable.getInstance().getAllSchemes(player.getObjectId()).tail(); (e = e.getNext()) != end;)
		{
			tb.append("<tr><td width=\"140\">"
					+ e.getKey()
					+ " ("
					+ String.valueOf(CharSchemesTable.getInstance().getScheme(player.getObjectId(), e.getKey()).size())
					+ " skill(s))</td>");
			tb.append("<td width=\"60\"><button value=\"Clear\" action=\"bypass -h npc_%objectId%_clearscheme "
					+ e.getKey()
					+ "\" width=50 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
			tb.append("<td width=\"60\"><button value=\"Drop\" action=\"bypass -h npc_%objectId%_deletescheme "
					+ e.getKey()
	...
	tb.append("</table>");
	tb.append("<br><font color=\"LEVEL\">Max schemes per player: " + String.valueOf(6)
			+ "</font>");
	tb.append("<br><br>");
	tb.append("<button action=\"bypass -h npc_%objectId%_menu\" value=\"Back\" width=90 height=21 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
	tb.append("</body></html>");
...
private String getPlayerSchemeListFrame(L2PcInstance player, String skill_group, String scheme_key)
{
	...
	else
	{
		...
		for (FastMap.Entry<String, FastList<Integer>> e = CharSchemesTable.getInstance().getAllSchemes(player.getObjectId()).head(), end = CharSchemesTable.getInstance().getAllSchemes(player.getObjectId()).tail(); (e = e.getNext()) != end;)
		{
			if (count == 0)
				tb.append("<tr>");
			tb.append("<td width=\"90\"><a action=\"bypass -h npc_%objectId%_editschemes "
					+ skill_group + " " + e.getKey() + "\">" + e.getKey() + "</a></td>");
			count++;
			if (count == 3)
			{
				tb.append("</tr>");
...
private String getGroupSkillListFrame(L2PcInstance player, String skill_group, String scheme_key)
{
	...
	for (Integer skId : BufferSkillsTable.getInstance().getSkillsByType(skill_group))
	{
		if (CharSchemesTable.getInstance().getScheme(player.getObjectId(), scheme_key) != null
				...
				&& CharSchemesTable.getInstance().getSchemeContainsSkill(player.getObjectId(), scheme_key, skId))
		{
			continue;
		}
		...
		tb.append("<td width=\"100\"><a action=\"bypass -h npc_%objectId%_skillselect "
				+ skill_group + " " + scheme_key + " " + String.valueOf(skId) + "\">"
				+ skill.getName() + " (" + String.valueOf(maxlevel) + ")</a></td>");
 ...
 */
private String getPlayerSkillListFrame(L2PcInstance player, String skill_group,
		String scheme_key)
{
	if (skill_group == null || skill_group == "unselected")
		return "<br>Select a skill group first";
	...
	for (int skId : CharSchemesTable.getInstance().getScheme(player.getObjectId(), scheme_key))
	{
		if (count == 0)
			tb.append("<tr>");
		tb.append("<td><a action=\"bypass -h npc_%objectId%_skillunselect " + skill_group + " "
				+ scheme_key + " " + String.valueOf(skId) + "\">"
				+ SkillTable.getInstance().getInfo(skId, 1).getName() + "</a></td>");
		count++;
		if (count == 3)
		{
			tb.append("</tr>");
