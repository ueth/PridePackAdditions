...
public void onBypassFeedback(L2PcInstance player, String command)
{
	...
	else if (command.startsWith("Subclass"))
	{
		...
		{
			player.sendMessage("You cannot subclass while in combat mode");
			return;
		}
		...
		case 1: // Add Subclass - Initial
			...
			if (player.isInCombat())
			{
				player.sendMessage("You cannot add subclass while in combat mode");
				return;
			}
		...
		case 2: // Change Class - Initial
			if (player.isInCombat())
			{
				player.sendMessage("You cannot change subclass while in combat mode");
				return;
			}
		...
		case 3: // Change/Cancel Subclass - Initial
			if (player.isInCombat())
			{
				player.sendMessage("You cannot manage subclasses while in combat mode");
				return;
			}
