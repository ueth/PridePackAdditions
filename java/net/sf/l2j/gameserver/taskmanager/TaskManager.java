...
import net.sf.l2j.gameserver.taskmanager.tasks.TaskEvents;
import net.sf.l2j.gameserver.taskmanager.tasks.TaskEventsSmall;
...
private void initializate()
{
	...
	registerTask(new TaskEvents());
	registerTask(new TaskEventsSmall());
}
