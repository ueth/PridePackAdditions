...
public abstract class AbstractMainEvent extends Event implements Configurable, EventGame
{
	...
	protected boolean dividePlayers()
	{
		...
		/**/ if(NexusLoader.detailedDebug) print("AbstractMainEvent: aviable instances = " + aviableInstances);
	...
	{
		/**/ if(NexusLoader.detailedDebug) print("AbstractMainEvent: spawning npc " + x + ", " + y + ", " + z + ", npc id " + npcId + ", instance " + instanceId + ", name " + name + ", title " + title); 
	...
	public void onDisconnect(PlayerEventInfo player)
	{
		...
		{
			/**/ if(NexusLoader.detailedDebug) print("AbstractMainEvent: player " + player.getPlayersName() + " (instance id = " + player.getInstanceId() + ") disconnecting from the event");
			...
			if(playersMatch == null)
			{
				...
				/**/ if(NexusLoader.detailedDebug) print("AbstractMainEvent: !!! -.- player's EVENT INSTANCE is null after calling onDisconnect. Player's instanceId is = " + player.getInstanceId());
				running = false;
			}
			else 
